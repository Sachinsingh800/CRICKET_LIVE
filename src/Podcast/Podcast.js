     ...
     <div className={style.PodcastBox}>
           {PodcastData.map((item)=>
            <div className={style.podcast}>
              <iframe width="300" height="230" src={`https://www.youtube.com/embed${item.url}`}title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" allowfullscreen></iframe>
           </div>
           )}
    </div>  
